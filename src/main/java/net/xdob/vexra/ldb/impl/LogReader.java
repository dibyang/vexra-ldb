...
import static net.xdob.vexra.ldb.impl.LogChunkType.*;
import static net.xdob.vexra.ldb.impl.LogConstants.BLOCK_SIZE;
import static net.xdob.vexra.ldb.impl.LogConstants.HEADER_SIZE;
import static net.xdob.vexra.ldb.impl.Logs.getChunkChecksum;
