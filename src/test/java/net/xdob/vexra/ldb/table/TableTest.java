...
public abstract class TableTest
{
    ...
    public void testEmptyFile()
            throws Exception
    {
        createTable(file.getAbsolutePath(), fileChannel, new BytewiseComparator(), true, new Options());
    }
            ...
            throws IOException
    {
        ...
        Table table = createTable(file.getAbsolutePath(), fileChannel, new BytewiseComparator(), true, new Options());
