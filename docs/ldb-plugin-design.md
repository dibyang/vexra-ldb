...
| Property | 含义 | 示例字段 |
| --- | --- | --- |
| `ldb.plugins` | 当前插件列表 | `0:com.example.AuditPlugin,1:com.example.MetricsPlugin` |
...
- 新增 `LdbPluginDescriptor`、`LdbPluginFailurePolicy`，用于暴露插件名称、版本、顺序和失败策略。
